...
export interface TracesDefinition {
  traces_collected: {
    ...
    xray?: XrayDefinition;
    otlp?: [OtlpObjectDefinition, ...OtlpObjectDefinition[]] | OtlpObjectDefinition;
  };
  /**
...
export interface OtlpObjectDefinition {
  /**
   * gRPC endpoint to use to listen for OTLP protobuf information
   */
  grpc_endpoint?: string;
  /**
   * HTTP endpoint to use to listen for OTLP JSON information
   */
